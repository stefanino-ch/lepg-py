...
class MainWindow(QMainWindow):
        ...
        if config.getCheckForUpdates() == 'yes':
            ...
            if versChk.remoteVersionFound():
                ...
                if version.parse(remoteVersion) > version.parse(__version__):
                    ...
                    msgBox.setText(_('Current Version: ')
                                   + str(__version__)+('<br>')
                                   + _('Version on remote: ')
                                   + str(remoteVersion)+('<br>')
    ...
    def buildFileMenu(self):
        ...
        fileDataStatusAct.setStatusTip(_('Provides an overview about what '
    ...
    def buildPreProcMenu(self):
        ...
        preProcCellsDistrAct.setStatusTip(
    ...
    def preProcRun(self):
        ...
        if preProcRunner.preProcConfigured() is False:
            msgBox = QMessageBox()
            msgBox.setWindowTitle(_('Potentially missing configuration!'))
            msgBox.setText(_('For a successful pre-processor run you must '
    ...
    def buildProcMenu(self):
        ...
        procExtradColors_A.setStatusTip(_('Edit the color settings of the '
                                          'upper sail'))
        procExtradColors_A.triggered.connect(self.procExtradColorsEdit)

        procIntradColors_A = QAction(_('Colors lower sail'), self)
        procIntradColors_A.setStatusTip(_('Edit the color settings of the '
                                          'lower sail'))
    ...
    def procRun(self):
        ...
        if procRunner.procConfigured() is False:
            msgBox = QMessageBox()
            msgBox.setWindowTitle(_('Potentially missing configuration!'))
            msgBox.setText(_('For a successful processor run you must '
    ...
    def buildPlanMenu(self):
        ...
        planDxfLayerNames_A.setStatusTip(_('Edit the names of the individual '
                                           'DXF layers'))
        planDxfLayerNames_A.triggered.connect(self.planDxFLayerNamesEdit)

        procMarksT_A = QAction(_('Marks types'), self)
        procMarksT_A.setStatusTip(_('Edit individual paramters for the marks '
                                    'on the plans'))
    ...
    def buildSetupMenu(self):
        ...
        setupLangEnAct.setStatusTip('Switches the display language '
                                    'to englisch')
        ...
        setupUpdCheckAct.setStatusTip(_('Setup if and for which version '
