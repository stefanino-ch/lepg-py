...
from PyQt5.QtWidgets import QMdiSubWindow, QWidget, QSizePolicy, QHeaderView, QSpinBox, QLabel, \
    QTabWidget, QHBoxLayout, QVBoxLayout, QPushButton, QDataWidgetMapper
...
class Lines(QMdiSubWindow):
    ...
    def addTab(self):
        ...
        self.proxyModel[currNumTabs].setFilterKeyColumn(ProcessorModel.LinesModel.ConfigNumCol)
        ...
        branchTable.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        ...
        branchTable.setHelpText(ProcessorModel.LinesModel.OrderNumCol, _('OrderNumDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.NumBranchesCol , _('Lines-NumBranchesDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.BranchLvlOneCol , _('Lines-BranchLvlOneDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.OrderLvlOneCol , _('Lines-OrderLvlOneDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.LevelOfRamTwoCol , _('Lines-LevelOfRamTwoDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.OrderLvlTwoCol , _('Lines-OrderLvlTwoDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.LevelOfRamThreeCol , _('Lines-LevelOfRamThreeDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.OrderLvlThreeCol , _('Lines-OrderLvlThreeDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.BranchLvlFourCol , _('Lines-BranchLvlFourDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.OrderLvlFourCol , _('Lines-OrderLvlFourDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.AnchorLineCol , _('Lines-AnchorLineDesc'))
        branchTable.setHelpText(ProcessorModel.LinesModel.AnchorRibNumCol , _('Lines-AnchorRibNumDesc'))
