c***************************************************************
c      LE PARAGLIDING v 3.19 "Vinebre"
c      Pere Casellas 2010-2022
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       lepv="3.19"            ! Version
       lepd="2022-05-22"      ! Date
       lepc='"Vinebre"'       ! Code name
       lepuser="GENERAL"  
       ich=0
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       if (pp29(5,1).eq.1) then ! Open external DXF
       open(unit=27,file='lep-3d-surfaces.scad') 
       open(unit=28,file='lep-3d-surfaces.stl') 
       end if
...
c      Call 3D tessellation
       nsegments=8 ! increment for more detail
...
c      Customized header
     ...
     + " LABORATORI D'ENVOL PARAGLIDING",lepv,"version",lepc
       write (23,*) "by Pere Casellas 2010-2022"
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       if (rib(i,14).eq.0.or.atp.eq."ss") then ! Vents cases
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc   
     ...
     + xlength*2./100.," m"
       ...
       write (*,*) "   lep-3d-surfaces.stl"
       write (*,*) "   lep-3d-surfaces.scad"
       end if
       write (*,*) "   lep-out.txt"
       write (*,*) "   lines.txt"
       write (*,*)
